...
namespace Start3pointsLib
{
    public class Start3point : IShape
    {
        ...
        public string Name => "Star3Points";
        public int IconKind => (int)PackIconKind.StarThreePointsOutline;
        ...
        {
            star_point.Add(new Point(1, 1));
            star_point.Add(new Point(3, 1.7));
            star_point.Add(new Point(5, 1));
            star_point.Add(new Point(3.3692, 2.5173456));
            star_point.Add(new Point(3, 4.464));
            star_point.Add(new Point(2.5301, 2.5173456));
