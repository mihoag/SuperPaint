...
namespace LightningLib
{
    public class Lightning : IShape
    {
        ...
        public int IconKind => (int)PackIconKind.LightningBoltOutline;
        ...
        {
            star_point.Add(new Point(229, 10));
            star_point.Add(new Point(203, 29));
            star_point.Add(new Point(228, 45));
            star_point.Add(new Point(218, 52));
            star_point.Add(new Point(240, 67));
            star_point.Add(new Point(232, 73));
            star_point.Add(new Point(266, 98));
            star_point.Add(new Point(247, 64));
            star_point.Add(new Point(254, 59));
            star_point.Add(new Point(235, 40));
            star_point.Add(new Point(242, 36));
