...
namespace PlusLib
{
    public class PlusShape : IShape
    {
        ...
        public int IconKind => (int)PackIconKind.PlusOutline;
        ...
        public void HandleStart(double x, double y)
        {
            ...
            arrow_point.Add(new Point(2, 2));
            arrow_point.Add(new Point(2, 1));
            arrow_point.Add(new Point(3, 1));
            arrow_point.Add(new Point(3, 2));
            arrow_point.Add(new Point(4, 2));
            arrow_point.Add(new Point(4, 3));
            arrow_point.Add(new Point(3, 3));
            arrow_point.Add(new Point(3, 4));
            arrow_point.Add(new Point(2, 4));
            arrow_point.Add(new Point(2, 3));
            arrow_point.Add(new Point(1, 3));
