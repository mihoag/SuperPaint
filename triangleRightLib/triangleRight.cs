...
namespace triangleRightLib
{
    public class triangleRight : IShape
    {
        ...
        public string Name => "TriangleRight";
        public int IconKind => (int)PackIconKind.FlagTriangle;
        ...
        {
            triangle_point.Add(new Point(1, 3));
            triangle_point.Add(new Point(1, 1));
            triangle_point.Add(new Point(5, 1));
