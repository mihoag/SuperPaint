...
namespace start4point
{
    public class start4point : IShape
    {
        ...
        public string Name => "Star4Points";
        public int IconKind => (int)PackIconKind.StarFourPointsOutline;
        ...
        {
            star_point.Add(new Point(61, 10));
            star_point.Add(new Point(49, 48));
            star_point.Add(new Point(15, 61));
            star_point.Add(new Point(50, 72));
            star_point.Add(new Point(61, 110));
            star_point.Add(new Point(73, 72));
            star_point.Add(new Point(107, 61));
            star_point.Add(new Point(73, 48));
