...
namespace LeftArrowLib
{
    public class LeftArrow : IShape
    {
        ...
        public string Name => "LeftArrow";
        public int IconKind => (int)PackIconKind.ArrowLeft;
        ...
        public void HandleStart(double x, double y)
        {
            ...
            arrow_point.Add(new Point(9, 2));
            arrow_point.Add(new Point(9, 4));
