...
using AdornerLib;
namespace ArrowBotLib
{
    public class ArrowBot  : IShape
    {
        ...
        public string Name => "BotArrow";
        public int IconKind => (int)PackIconKind.ArrowTop;
        ...
        public void HandleStart(double x, double y)
        {
            ...
            arrow_point.Add(new Point(6, 9));
            arrow_point.Add(new Point(4, 9));
