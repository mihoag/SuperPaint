...
namespace StartSixPoint
{
    public class Startsixpoint : IShape
    {
        ...
        public string Name => "StarSixpoint";
        public int IconKind => (int)PackIconKind.StarsOutline;
        ...
        {
            star_point.Add(new Point(454, 20));
            star_point.Add(new Point(438, 48));
            star_point.Add(new Point(408, 46));
            star_point.Add(new Point(424, 73));
            star_point.Add(new Point(408, 99));
            star_point.Add(new Point(438, 97));
            star_point.Add(new Point(454, 126));
            star_point.Add(new Point(469, 97));
            star_point.Add(new Point(498, 99));
            star_point.Add(new Point(480, 73));
            star_point.Add(new Point(499, 47));
            star_point.Add(new Point(468, 48));
